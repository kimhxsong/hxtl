...
class map {
 public:
  ...
  typedef typename ft::__tree<value_type, value_compare, Allocator>::iterator iterator;
  typedef typename ft::__tree<value_type, value_compare, Allocator>::const_iterator const_iterator;
 ...
 public:
  ...
  mapped_type& operator[](const key_type& k) {
    iterator found = base.find(ft::make_pair(k, mapped_type()));
    if (found != this->end()) {
      return found->second;
    } else
      return base.insert(ft::make_pair(k, mapped_type())).first->second;
  }
  ...
  size_type erase(const key_type& k) { return base.erase(ft::make_pair(k, mapped_type())); }
  ...
  iterator find(const key_type& k) { return base.find(ft::make_pair(k, mapped_type())); }

  const_iterator find(const key_type& k) const {
    return base.find(ft::make_pair(k, mapped_type()));
  }

  size_type count(const key_type& k) const { return base.count(ft::make_pair(k, mapped_type())); }
  ...
  iterator lower_bound(const key_type& k) {
    return base.lower_bound(ft::make_pair(k, mapped_type()));
  }
  ...
  iterator upper_bound(const key_type& k) {
    return base.upper_bound(ft::make_pair(k, mapped_type()));
  }
  ...
  pair<const_iterator, const_iterator> equal_range(const key_type& k) const {
    return base.equal_range(ft::make_pair(k, mapped_type()));
  }
...
template <class _Key, class _T, class _Comp, class _Alloc>
bool operator==(const ft::map<_Key, _T, _Comp, _Alloc>& lhs,
                const ft::map<_Key, _T, _Comp, _Alloc>& rhs) {
