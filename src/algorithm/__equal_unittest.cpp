...
TEST(equal, predicate__2) {
  ...
  EXPECT_EQ(ft::equal(__std__list.begin(), __std__list.end(),
                      __std__vec.begin(), std::equal_to<int>()), true);
  EXPECT_EQ(ft::equal(__std__vec.begin(), __std__vec.end(),
                      __std__list.begin(), std::equal_to<int>()), true);
  EXPECT_EQ(ft::equal(__std__multiset.begin(), __std__multiset.end(),
                      __std__vec.begin(), std::equal_to<int>()), true);
  EXPECT_EQ(ft::equal(__std__vec.begin(), __std__vec.end(),
                      __std__multiset.begin(), std::equal_to<int>()), true);

  EXPECT_EQ(ft::equal(__std__list.begin(), __std__list.end(),
                      __std__vec.begin(), std::not_equal_to<int>()), false);
  EXPECT_EQ(ft::equal(__std__vec.begin(), __std__vec.end(),
                      __std__list.begin(), std::not_equal_to<int>()), false);
  EXPECT_EQ(ft::equal(__std__multiset.begin(), __std__multiset.end(),
                      __std__vec.begin(), std::not_equal_to<int>()), false);
  EXPECT_EQ(ft::equal(__std__vec.begin(), __std__vec.end(),
                      __std__multiset.begin(), std::not_equal_to<int>()), false);
}
