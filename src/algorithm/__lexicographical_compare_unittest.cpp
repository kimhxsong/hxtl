...
TEST(equal, equality__1) {
  ...
  EXPECT_EQ(std::equal(__std__map.begin(), __std__map.end(),
                       __std__map2.begin()), true);
  EXPECT_EQ(ft::lexicographical_compare(__std__map.begin(), __std__map.end(),
                                        __std__map2.begin(), __std__map2.end()),
                                        false);
  EXPECT_EQ(std::lexicographical_compare(__std__map.begin(), __std__map.end(),
                                         __std__map2.begin(), __std__map2.end()),
