...
{
  EXPECT_EQ(
      typeid(std::iterator_traits<std::vector<int>::iterator>::difference_type)
          .name(),
      typeid(ft::iterator_traits<std::vector<int>::iterator>::difference_type)
          .name());
  EXPECT_EQ(typeid(std::iterator_traits<std::vector<int>::iterator>::value_type)
                .name(),
            typeid(ft::iterator_traits<std::vector<int>::iterator>::value_type)
                .name());
  EXPECT_EQ(
      typeid(std::iterator_traits<std::vector<int>::iterator>::pointer).name(),
      typeid(ft::iterator_traits<std::vector<int>::iterator>::pointer).name());
  EXPECT_EQ(typeid(std::iterator_traits<std::vector<int>::iterator>::reference)
                .name(),
            typeid(ft::iterator_traits<std::vector<int>::iterator>::reference)
                .name());
  EXPECT_EQ(
      typeid(
          std::iterator_traits<std::vector<int>::iterator>::iterator_category)
          .name(),
      typeid(ft::iterator_traits<std::vector<int>::iterator>::iterator_category)
          .name());
};
