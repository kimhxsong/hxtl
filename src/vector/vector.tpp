...
vector<T, Alloc>::vector(typename enable_if<!is_integral<InputIterator>::value,
...
template <typename T, typename Alloc> vector<T, Alloc>::vector(const vector& x)
    : alloc_(x.alloc_),
...
template <typename T, typename Alloc> typename vector<T, Alloc>::const_reference
...
template <typename T, typename Alloc> void vector<T, Alloc>::swap(vector& other)
{
...
template <typename T, typename Alloc> void vector<T, Alloc>::clear()
{
  for (size_type i = 0; i < size_; i++)
  {
    alloc_.destroy(&elem_[i]);
...
template <typename T, typename Alloc> template <class InputIterator> void
vector<T, Alloc>::assign(typename enable_if<!is_integral<InputIterator>::value,
                                            InputIterator>::type first,
                         InputIterator last)
{
  clear();
...
template <typename T, typename Alloc> typename vector<T, Alloc>::allocator_type
...
template <typename T, typename Alloc> typename vector<T, Alloc>::iterator
