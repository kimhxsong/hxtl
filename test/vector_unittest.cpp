...
TEST(ReverseIteratorConstructor, default_constructor) {
  std::ReverseIterator<int> vi_1;
  ft::ReverseIterator<int> vi_2;

  EXPECT_EQ(vi_1.size(), vi_2.size());
  std::ReverseIterator<std::string> vstr_1;
  ft::ReverseIterator<std::string> vstr_2;
}

TEST(ReverseIteratorConstructor, fill_constructor) {
  std::ReverseIterator<int> vi_1(10);
  std::ReverseIterator<std::string> vstr_1(10);
}

TEST(ReverseIteratorConstructor, range_constructor) {
  std::ReverseIterator<int> vi_1;
  std::ReverseIterator<int> vi_2(vi_1.begin(), vi_1.end());
}

TEST(ReverseIteratorConstructor, copy_constructor) {
  std::ReverseIterator<int> vi_1;
  std::ReverseIterator<int> vi_2(vi_1);
}

TEST(ReverseIteratorIterator, iterator) {
  std::ReverseIterator<int> vi_1(10);
  vi_1.begin();
  vi_1.end();
}
